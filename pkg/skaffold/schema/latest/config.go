...
type GoogleCloudBuild struct {
	...
	// Set the Available secrets for the cloudbuild docker job
	...
	// Set the prebuild steps for the cloudbuild docker job
...
type TerrformDeployments struct {
	// The name of the deployment. This is used to create ordering in the terraform deployment
	Name string `yaml:"name,omitempty"`
	// ProjectID the GCP Project to use for Cloud Run.
	// If specified, all Services will be deployed to this project. If not specified,
	// each Service will be deployed to the project specified in `metadata.namespace` of
